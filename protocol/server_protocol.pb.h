...
class packet_server_connect : public ::google::protobuf::Message {
 public:
  ...
  inline const ::login2chk::RoomInfo& info(int index) const;
  inline ::login2chk::RoomInfo* mutable_info(int index);
  inline ::login2chk::RoomInfo* add_info();
 ...
 private:
  ...
  int packet_id_;
  ::google::protobuf::uint32 server_id_;
  ::google::protobuf::RepeatedPtrField< ::login2chk::RoomInfo > info_;
  int server_type_;
...
class packet_room_register : public ::google::protobuf::Message {
 public:
  packet_room_register();
  virtual ~packet_room_register();

  packet_room_register(const packet_room_register& from);

  inline packet_room_register& operator=(const packet_room_register& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const packet_room_register& default_instance();

  void Swap(packet_room_register* other);

  // implements Message ----------------------------------------------

  packet_room_register* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const packet_room_register& from);
  void MergeFrom(const packet_room_register& from);
  void Clear();
  bool IsInitialized() const;
  ...
  // @@protoc_insertion_point(class_scope:server_protocols.packet_room_register)
 private:
  inline void set_has_packet_id();
  inline void clear_has_packet_id();
  inline void set_has_server_id();
  ...
  void InitAsDefaultInstance();
  static packet_room_register* default_instance_;
};
// -------------------------------------------------------------------
...
// required string server_IP = 5;
inline bool packet_server_register::has_server_ip() const {
  return (_has_bits_[0] & 0x00000010u) != 0;
}
inline void packet_server_register::set_has_server_ip() {
  _has_bits_[0] |= 0x00000010u;
}
inline void packet_server_register::clear_has_server_ip() {
  _has_bits_[0] &= ~0x00000010u;
}
inline void packet_server_register::clear_server_ip() {
  if (server_ip_ != &::google::protobuf::internal::kEmptyString) {
    server_ip_->clear();
  }
  clear_has_server_ip();
}
inline const ::std::string& packet_server_register::server_ip() const {
  return *server_ip_;
}
inline void packet_server_register::set_server_ip(const ::std::string& value) {
  set_has_server_ip();
  if (server_ip_ == &::google::protobuf::internal::kEmptyString) {
...
inline void packet_server_register::set_server_ip(const char* value) {
  set_has_server_ip();
  if (server_ip_ == &::google::protobuf::internal::kEmptyString) {
    server_ip_ = new ::std::string;
  }
...
inline void packet_server_register::set_server_ip(const char* value, size_t size) {
  set_has_server_ip();
  if (server_ip_ == &::google::protobuf::internal::kEmptyString) {
    server_ip_ = new ::std::string;
  }
...
inline ::std::string* packet_server_register::mutable_server_ip() {
  set_has_server_ip();
  if (server_ip_ == &::google::protobuf::internal::kEmptyString) {
    server_ip_ = new ::std::string;
  }
...
inline ::std::string* packet_server_register::release_server_ip() {
  clear_has_server_ip();
  if (server_ip_ == &::google::protobuf::internal::kEmptyString) {
    return NULL;
  } else {
...
inline void packet_server_register::set_allocated_server_ip(::std::string* server_ip) {
  if (server_ip_ != &::google::protobuf::internal::kEmptyString) {
    delete server_ip_;
  }
  if (server_ip) {
...
// repeated .login2chk.RoomInfo info = 4;
inline int packet_server_connect::info_size() const {
  return info_.size();
}
inline void packet_server_connect::clear_info() {
  info_.Clear();
}
inline const ::login2chk::RoomInfo& packet_server_connect::info(int index) const {
  return info_.Get(index);
}
inline ::login2chk::RoomInfo* packet_server_connect::mutable_info(int index) {
  return info_.Mutable(index);
}
inline ::login2chk::RoomInfo* packet_server_connect::add_info() {
  return info_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::login2chk::RoomInfo >&
packet_server_connect::info() const {
  return info_;
}
inline ::google::protobuf::RepeatedPtrField< ::login2chk::RoomInfo >*
packet_server_connect::mutable_info() {
  return &info_;
}
...
// optional .server_protocols.e_server_msg_type packet_id = 1 [default = e_mst_room_list_connect];
inline bool packet_room_register::has_packet_id() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void packet_room_register::set_has_packet_id() {
  _has_bits_[0] |= 0x00000001u;
}
inline void packet_room_register::clear_has_packet_id() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void packet_room_register::clear_packet_id() {
  packet_id_ = 21;
  clear_has_packet_id();
}
inline ::server_protocols::e_server_msg_type packet_room_register::packet_id() const {
  return static_cast< ::server_protocols::e_server_msg_type >(packet_id_);
}
inline void packet_room_register::set_packet_id(::server_protocols::e_server_msg_type value) {
  assert(::server_protocols::e_server_msg_type_IsValid(value));
  set_has_packet_id();
  packet_id_ = value;
}
...
// optional fixed32 server_id = 2;
inline bool packet_room_register::has_server_id() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void packet_room_register::set_has_server_id() {
  _has_bits_[0] |= 0x00000002u;
}
inline void packet_room_register::clear_has_server_id() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void packet_room_register::clear_server_id() {
  server_id_ = 0u;
  clear_has_server_id();
}
inline ::google::protobuf::uint32 packet_room_register::server_id() const {
  return server_id_;
}
inline void packet_room_register::set_server_id(::google::protobuf::uint32 value) {
  set_has_server_id();
  server_id_ = value;
}

// optional .server_protocols.e_server_type server_type = 3;
inline bool packet_room_register::has_server_type() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void packet_room_register::set_has_server_type() {
  _has_bits_[0] |= 0x00000004u;
}
inline void packet_room_register::clear_has_server_type() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void packet_room_register::clear_server_type() {
  server_type_ = 0;
  clear_has_server_type();
}
inline ::server_protocols::e_server_type packet_room_register::server_type() const {
  return static_cast< ::server_protocols::e_server_type >(server_type_);
}
inline void packet_room_register::set_server_type(::server_protocols::e_server_type value) {
  assert(::server_protocols::e_server_type_IsValid(value));
  set_has_server_type();
  server_type_ = value;
}
...
// repeated .login2chk.RoomInfo info = 4;
inline int packet_room_register::info_size() const {
  return info_.size();
}
inline void packet_room_register::clear_info() {
  info_.Clear();
}
inline const ::login2chk::RoomInfo& packet_room_register::info(int index) const {
  return info_.Get(index);
}
inline ::login2chk::RoomInfo* packet_room_register::mutable_info(int index) {
  return info_.Mutable(index);
}
inline ::login2chk::RoomInfo* packet_room_register::add_info() {
  return info_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::login2chk::RoomInfo >&
packet_room_register::info() const {
  return info_;
}
inline ::google::protobuf::RepeatedPtrField< ::login2chk::RoomInfo >*
packet_room_register::mutable_info() {
  return &info_;
}
