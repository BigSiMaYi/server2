...
inline const ::msg_info_def_ex::msg_account_info_ex& packetw2l_enter_friend_room::account_info_ex() const {
  return account_info_ex_ != NULL ? *account_info_ex_ : *default_instance_->account_info_ex_;
}
inline ::msg_info_def_ex::msg_account_info_ex* packetw2l_enter_friend_room::mutable_account_info_ex() {
...
inline ::msg_info_def_ex::msg_account_info_ex* packetw2l_enter_friend_room::release_account_info_ex() {
  clear_has_account_info_ex();
  ::msg_info_def_ex::msg_account_info_ex* temp = account_info_ex_;
  account_info_ex_ = NULL;
  return temp;
}
inline void packetw2l_enter_friend_room::set_allocated_account_info_ex(::msg_info_def_ex::msg_account_info_ex* account_info_ex) {
