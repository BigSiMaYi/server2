...
std::auto_ptr<RedBlack_RoomStockCFG> RedBlack_RoomStockCFG::msSingleton(nullptr);

int RedBlack_RoomStockCFG::GetCount()
{
	return (int)mMapData.size();
}

const RedBlack_RoomStockCFGData* RedBlack_RoomStockCFG::GetData(int RoomID)
{
...
boost::unordered_map<int, RedBlack_RoomStockCFGData>& RedBlack_RoomStockCFG::GetMapData()
{
	return mMapData;
}

void RedBlack_RoomStockCFG::Reload()
{
	mMapData.clear();
	Load();
}

void RedBlack_RoomStockCFG::Load()
{
	std::ifstream readStream("../Config/RedBlack_RoomStockCFG.xml", std::ios::binary);
	...
	while (element != NULL)
	{
		RedBlack_RoomStockCFGData data;
		...
		data.mRobotMinBetTime = element->IntAttribute("RobotMinBetTime");
		data.mRobotMaxBetTime = element->IntAttribute("RobotMaxBetTime");
...
RedBlack_RoomStockCFG* RedBlack_RoomStockCFG::GetSingleton()
{
	if (msSingleton.get() == nullptr)
	{
		msSingleton.reset(new RedBlack_RoomStockCFG());
	}
