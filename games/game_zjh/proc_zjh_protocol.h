...
#include <zjh_protocol.pb.h>
#include <net/peer_tcp.h>

class i_game_player;
using namespace zjh_protocols;

void init_proc_zjh_protocol();
...
PACKET_REGEDIT_RECVGATE_LOG(peer_tcp, packetc2l_change_table, i_game_player);
PACKET_REGEDIT_SEND(packetl2c_change_table_result);
