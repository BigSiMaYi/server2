...
bmw_space::RobotPlayerPtr& bmw_space::robot_mgr::get_robot_player(uint32_t player_id)
{
...
uint32_t bmw_space::robot_mgr::get_robot_count()
{
	return m_robot_players.size();
}

void bmw_space::robot_mgr::robot_player_leave(uint32_t player_id)
{
	auto it = m_robot_players.find(player_id);
...
void bmw_space::robot_mgr::robot_player_enter(RobotPlayerPtr& player)
{
...
void bmw_space::robot_mgr::recv_packet(uint32_t player_id, uint32_t packet_id, boost::shared_ptr<google::protobuf::Message> packet)
{
...
void bmw_space::robot_mgr::send_packet(uint32_t player_id, uint32_t packet_id, boost::shared_ptr<google::protobuf::Message> packet)
{
