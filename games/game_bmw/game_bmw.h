...
//#ifdef GAME_BMW_EXPORTS
//#define GAME_BMW_API __declspec(dllexport)
//#else
//#define GAME_BMW_API __declspec(dllimport)
//#endif
//
//extern "C" {
//
...
#elif defined(LINUX)
#ifdef GAME_BMW_EXPORTS
#define GAME_BMW_API __attribute__((visibility("default")))
#else
#define GAME_BMW_API
#endif
