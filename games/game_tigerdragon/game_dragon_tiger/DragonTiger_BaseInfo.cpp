...
boost::unordered_map<std::string, DragonTiger_BaseInfoData>& DragonTiger_BaseInfo::GetMapData()
{
	return mMapData;
}
...
{
	std::ifstream readStream("../Config/DragonTiger_BaseInfo.xml", std::ios::binary);
