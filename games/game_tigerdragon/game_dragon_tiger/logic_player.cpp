...
void logic_player::parse_nickname()
{
// 	std::string pbnk = m_player->get_nickname();
// 	std::string realpb = enable_crypto_helper::Base64Decode(pbnk);
// 	msg_info_def::msg_nickname_ex output;
// 	//output.ParseFromString(realpb);
// 	output.ParsePartialFromString(realpb);
// 	if (output.has_nickname())
// 		m_nickname = output.nickname();
